...
const MenuContentRenderer: React.FC<MenuContentRendererProps> = ({
  selectedItem,
  isSignedIn
}) => {
  switch (selectedItem) {
    ...
    case 'Friends':
      ...
      return null; // FriendsScreen will be rendered from parent
    case 'Settings':
      if (isSignedIn) {
        return (
          <div className="h-full flex flex-col items-center justify-center p-4 text-center">
      ...
      return null; // SettingsScreen will be rendered from parent
    case 'Edit My Five':
      return (
        <div className="h-full flex flex-col items-center justify-center p-4 text-center">
